...
from schemas.ride_schema import RideRequest, RideResopnse
...
@app.post("/request-ride", response_model=RideResopnse)
...
@app.get("/ride/{ride_id}", response_model=RideResopnse)
